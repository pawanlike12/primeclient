...
export default class MobileOtp extends Component{
    ...
    handleSubmit=()=>{
        ...
        fetch('http://203.190.153.20/primeclient/primeclientApi/Api/update_number',{
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        otp:this.state.value,
                        id: this.props.navigation.state.params.id,
                        cellphone: this.props.navigation.state.params.cellno,
               ...
               .then((responseJson) => {
                    ...
                    if(this.state.data['status']==1){
                        this.props.navigation.dispatch(StackActions.reset({
                            index: 0,
                            actions: [
                              NavigationActions.navigate({ routeName:'UserProfile', params:{id:this.props.navigation.state.params.id} })
                            ],
                          }))
                    }
                    else{
                            ...
                            Alert.alert('Set Password',this.state.data['message'],[
                              {
                                ...
                                onPress:() => {
                                  this.props.navigation.dispatch(StackActions.reset({
                                    index: 0,
                                    actions: [
                                      NavigationActions.navigate({ routeName:'MobileOtp', params:{id:this.props.navigation.state.params.id} })
                                    ],
                                  }))
                                  }
               ...
               <Image source={require('../assets/images/logo_small.png')} style={styles.Smalllogo} />
                 ...
                 <View style={{width:'100%', height:"100%", alignItems:"center", marginTop:5,
                  padding: 20, }}>
                   ...
                   <Text style={{fontSize:18, textAlign:"center", marginTop:20, fontFamily:"Raleway-Regular"}}>Please type the verification code sent to your cellphone {this.props.navigation.state.params.cellno}.</Text>
